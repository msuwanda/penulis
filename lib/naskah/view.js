...
function Views() {
  ...
  R.useEffect(function () {
    var data = { appkey: getKey(), pages: "" + count, search: [{ name: "ns_judul", value: "" + Search }, { name: "ns_penulis", value: "" + Search2 }, { name: "s_name", value: "" + Search3 }] };
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            { className: "page-link-prev", onClick: function onClick() {
                return window.location.href = '/300100#' + ("" + data.ns_id);
              } },
            "Rinci"
          )
        )
