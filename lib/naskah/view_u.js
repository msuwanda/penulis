...
function Views() {
  ...
  R.useEffect(function () {
    var data = { appkey: getKey(), pages: "" + count, search: [{ name: "ns_judul", value: "" + Search }, { name: "ns_penulis", value: "" + Search2 }, { name: "s_name", value: "" + Search3 }, { name: "usr_email", value: sessionStorage.getItem('email') }] };
  ...
  var items = Datas.map(function (data) {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "span",
          { className: "alert-" + data.s_class, style: { padding: '2px', borderRadius: '5px' } },
          data.s_name
        )
      ),
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            { className: "page-link-prev", onClick: function onClick() {
                return window.location.href = '/400100#' + ("" + data.ns_id);
              } },
            "Rinci"
          )
        )
